...
export const getAllProduct = async (pagination: Pagination) => await axios.get(
...
export const getProductByFeatureMode = async (featureMode: string, pagination: Pagination) => await axios.get(
...
export const getProductByCategoryName = async (categoryName: string, pagination: Pagination) => await axios.get(
...
export const getProductByProductName = async (productName: string, pagination: Pagination) => await axios.get(
...
export const getProductByPriceRange = async (minPrice: number, maxPrice: number, pagination: Pagination) => await axios.get(PRODUCT_REST_API_URL + `?maxPrice=${maxPrice}&minPrice=${minPrice}&direction=${pagination.direction}&pageNum=${pagination.currentPage}&pageSize=${pagination.pageSize}`, CORS_CONFIG);
