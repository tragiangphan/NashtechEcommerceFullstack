    ...
    <nav className="bg-white border-gray-200 dark:bg-gray-900">
      <div className="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto p-4">
        ...
        {showButton ? (
          ...
          <div className="flex items-center md:order-2 space-x-1 md:space-x-2 rtl:space-x-reverse">
            <button onClick={() => handleNavigationClick(cookies.username)} className="text-gray-800 dark:text-white hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 rounded-lg text-base font-semibold px-4 py-2 md:px-5 md:py-2.5 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">{cookies.username}</button>
